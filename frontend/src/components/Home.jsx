        ...
        <nav className="bg-white shadow-lg fixed w-full top-0 z-50">
            <div className="flex items-center justify-between p-4">
                ...
                <div className="flex items-center space-x-4">
                    <Link to="/newtodo" className="text-blue-500 hover:text-blue-700">
                        New Todo
                    </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
            ...
            <div className="grid gap-4 sm:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {[...todos]
                    ...
                    .map((todo) => {
                        const isDelayed = new Date(todo.dueDate) < new Date() && todo.status !== "completed";
                            ...
                            >
                                <div className="bg-white p-4 sm:p-6">
                                    <div className="flex justify-between items-start mb-4">
                                        <h3 className={`text-base sm:text-lg font-bold text-gray-900 line-clamp-1 ${isDelayed ? 'line-through' : ''}`}>
                                            {todo.title}
                                        </h3>
                                        <span
                                    ...
                                    <p className={`text-sm sm:text-base text-gray-600 mb-4 line-clamp-2 ${isDelayed ? 'line-through' : ''}`}>
                                        {todo.description}
                                    </p>
                                    ...
                                    <div className="flex flex-col space-y-3">
                                        ...
                                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-2 sm:space-y-0">
                                            {isDelayed ? (
                                                <span className="text-red-600 font-bold text-base">DELAYED</span>
                                            ) : (
                                                <>
                                                    <span
